...
public class MatthewBoyeaProjOne
{
    ...
    public static void main(String [] args){
        ...
        int [] arrCopy = arr;
        // NOTE: to test the speed of sorting algorithms against eachother
        // on the same random list, I added arrCopy and made all sorting
        // algorithms operate on the copy such that they wouldn't
        // operate on an array which had already been sorted -Matthew Boyea
        ...
        do{
            ...
            switch(choice){
                case 1: // generate a new random filled array
                    ...
                    break;
                case 2: // select sort
                    testSort(arrCopy, "Select Sort");
                    break;
                case 3: // insert sort
                    testSort(arrCopy, "Insert Sort");
                    break;
                case 4: // quick sort
                    testSort(arrCopy, "Quick Sort");
                    break;
                case 5: // merge sort
                    testSort(arrCopy, "Merge Sort");
                    break;
                case 6: // quit
